...
10. Convert VCF to Plink format for access to SAIGE and filter BED files [[Progress](https://github.com/exascale-genomics/mvp-wgs-sv/blob/main/data/convert_vcf_to_plink.md)].
...
15. Run SAIGE for 1KG WG BED data [[Progress](https://github.com/exascale-genomics/mvp-wgs-sv/blob/main/data/SAIGE-GPU_run_1kg_polaris.md)]
